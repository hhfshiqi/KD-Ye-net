...
class YeeNet(nn.Module):
    def __init__(self, with_bn=False, threshold=3):
        super(YeeNet, self).__init__()
        self.with_bn = with_bn
        ...
        self.block4 = ConvBlock(30, 32, 3, with_bn=self.with_bn)
        self.block5 = ConvBlock(32, 32, 3, with_bn=self.with_bn)
        self.pool3 = nn.AvgPool2d(3, 2)
        self.block6 = ConvBlock(32, 16, 3, with_bn=self.with_bn)
        self.block9 = ConvBlock(16, 16, 3, 2, with_bn=self.with_bn)
        # self.block7 = ConvBlock(16, 16, 5, with_bn=self.with_bn)
        self.ip1 = nn.Linear(61 * 61 * 16, 2)
        self.reset_parameters()
